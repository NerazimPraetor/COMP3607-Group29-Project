...
public class Game implements Subject{
    ...
    public void playTurn(Player p){
        ...
        GameContent question = manager.getQuestionInfo(c, value);
        ...
        if (Character.toUpperCase(question.getAnswer()) == Character.toUpperCase(answerAsChar)){
            ...
            p.addPoints(value);
            manager.markAsAnswered(question, c);
            result = "Correct";
        ...
        notify(log, turn, question.getQuestion());
