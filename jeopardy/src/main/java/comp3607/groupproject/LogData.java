...
public class LogData {
    ...
    public LogData(String caseID, String playerID, String activity, LocalDateTime timestamp, String category, int questionValue, char answerGiven, String result, int scoreAfterPlay){
        this.caseID = caseID;
