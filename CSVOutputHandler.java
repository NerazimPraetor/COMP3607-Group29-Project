    ...
    public void write(List<LogData> entries, File f){
        try(CSVWriter writer = new CSVWriter(new FileWriter(f))){
            ...
            for(LogData e : entries){
                String row[] = {e.getCaseID(), e.getPlayerID(), e.getActivity(), e.getTimestamp().toString(), e.getCategory(), String.valueOf(e.getQuestionValue()), e.getAnswerGiven() , e.getResult(), String.valueOf(e.getScoreAfterPlay())};
